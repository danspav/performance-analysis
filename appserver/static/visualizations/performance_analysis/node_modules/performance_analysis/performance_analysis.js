				...
				for (i=0; i<data.rows.length; i++){
					...
					if(typeof this.items[vizUtils.escapeHtml(data_item[fields["name"]])] === 'undefined') {
						...
						for(k=0;k<current_item.num_buckets;k++){
							...
							temp_bucket.warning_threshold = data_item[fields["ok_threshold"]] || this.ok_threshold;
							temp_bucket.warning_threshold = data_item[fields["warning_threshold"]] || this.warning_threshold;
							temp_bucket.warning_threshold = data_item[fields["high_threshold"]] || this.high_threshold;
							temp_bucket.warning_threshold = data_item[fields["veryHigh_threshold"]] || this.veryHigh_threshold;
