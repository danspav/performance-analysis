	...
	class  time_bucket {
		...
		getHTML(){
			...
			if (!this.showStatusAsText && !isNaN(this.average_status)){
				...
				data_tooltip='<b>Server:</b><br />Average: ' + this.average_value + '<br /><b>Application reported:</b><br />GREEN ' + this.num_green + ' time(s)<br />AMBER 0 time(s)<br />RED 0 time(s)';
			}else if (this.num_amber==0 && this.num_red==0 && this.num_green > 0){
				...
				data_tooltip='<b>Server:</b><br />Average: ' + this.average_value + '<br /><b>Application reported:</b><br />GREEN ' + this.num_green + ' time(s)<br />AMBER ' + this.num_amber + ' time(s)<br />RED 0 time(s)';
			} else{
				td_image= '<img src="/static/app/performance-analysis/images/red.png" style="width:16px; height: 16px;" width="16" height="16"/>';
				data_tooltip='<b>Server:</b><br />Average: ' + this.average_value + '<br /><b>Application reported:</b><br />GREEN ' + this.num_green + ' time(s)<br />AMBER ' + this.num_amber + ' time(s)<br />RED ' + this.num_red + ' time(s)';
			}
