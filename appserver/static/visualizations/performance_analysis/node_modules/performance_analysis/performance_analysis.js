	...
	*/
	class  time_bucket {
		...
		getHTML(){
			...
			//Wrap the tooltip in a title attribute
			if (data_tooltip!="") {
				data_tooltip = " title=\"" + data_tooltip + "\"";
			}
			html = '<td class="jds_ta_clickable ' + css_class + '" style="text-align:center;background-color: ' + colour + '!IMPORTANT" start_time="' + (this.start_time.getTime()/1000) + '" end_time="'+ (this.end_time.getTime()/1000) + '"' + data_tooltip + ' data-toggle="tooltip">' + td_image + '</td>';
