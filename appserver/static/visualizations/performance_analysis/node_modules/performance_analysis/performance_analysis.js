	...
	/*
		Search query must supply:
			...
			* result	| Provides a metric for the icon in the cell
			-------
			Optional values:
	...
	class  time_bucket {
		...
		getHTML(){
			...
			if (this.num_amber==0 && this.num_red==0 && this.num_green==0){
				...
				td_image='<img src="/static/app/performance-analysis/images/green.gif" style="width:16px; height: 16px;" width="16" height="16"  title="Application reported:&#13;GREEN ' + this.num_green + ' time(s)&#13;AMBER 0 time(s)&#13;RED 0 time(s)" />'
