	...
	*/
	...
	class performance_analysis{
		constructor(granularity, warning_threshold, critical_threshold,down_time_start,down_time_end,time_format,show_legend,showStatusAsText){
			...
			this.showStatusAsText = showStatusAsText;
			//----------------
			this.data_item;
			this.current_item;
		}
		...
		setData(data){
			...
			try{
				...
				console.log("Error setting data. Number of buckets=" + this.buckets.length + ", bucket_index=" + bucket_index);
			}
		}
	...
	class  time_bucket {
		...
		add_item(result_row,fields){
			...
			try{
				...
				this.sum_value += temp_status;
				this.average_status = Math.round(this.sum_status/ this.total,2); 
