	...
	class  time_bucket {
		...
		getHTML(){
			...
			if (!this.showStatusAsText && !isNaN(this.average_status)){
				...
				data_tooltip='<b>Application reported:</b><br />GREEN ' + this.num_green + ' time(s)<br />AMBER 0 time(s)<br />RED 0 time(s)';
			}else if (this.num_amber==0 && this.num_red==0 && this.num_green > 0){
				...
				data_tooltip='<b>Application reported:</b><br />GREEN ' + this.num_green + ' time(s)<br />AMBER ' + this.num_amber + ' time(s)<br />RED 0 time(s)';
			} else{
				...
				data_tooltip='<b>Application reported:</b><br />GREEN ' + this.num_green + ' time(s)<br />AMBER ' + this.num_amber + ' time(s)<br />RED ' + this.num_red + ' time(s)';
			}
